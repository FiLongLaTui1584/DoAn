...
public class TinyDB {
    ...
    public ArrayList<model_2> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<model_2> playerList = new ArrayList<model_2>();

        for (String jObjString : objStrings) {
            model_2 player = gson.fromJson(jObjString, model_2.class);
    ...
    public void putListObject(String key, ArrayList<model_2> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (model_2 player : playerList) {
