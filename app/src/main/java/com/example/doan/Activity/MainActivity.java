...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadData() {
        arr_sanpham.add(new PopularModel("iPhone 15 Pro Max",R.drawable.ip15pm,31.79,10,4.9));
        arr_sanpham.add(new PopularModel("iPad Pro M2 2022",R.drawable.ipad_prom2,20.39,12,5.0));
        arr_sanpham.add(new PopularModel("iPhone 14 Pro Max",R.drawable.ip14pm,27.39,10,4.5));
        arr_sanpham.add(new PopularModel("iPhone 13 Pro Max",R.drawable.ip13pm,22.99,10,4.0));
    }
